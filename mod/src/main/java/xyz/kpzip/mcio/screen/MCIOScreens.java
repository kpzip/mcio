...
public class MCIOScreens {
	...
	public static final MenuType<MCUInterfaceScreenHandler> MCU_INTERFACE_SCREEN_HANDLER = Registry.register(BuiltInRegistries.MENU, ResourceLocation.tryBuild(MCIO.MOD_ID, "mcu_interface"), new MenuType<MCUInterfaceScreenHandler>(MCUInterfaceScreenHandler::new, FeatureFlags.VANILLA_SET));
